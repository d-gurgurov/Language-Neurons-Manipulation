...
n, over_zero = [], []
for lang in ["bo", "mt", "it", "es", "de", "ja", "ar", "zh", "af", "nl", "fr", "pt", "ru", "ko", "hi", "tr", "pl", "sv", "da", "no"]: # "bo", "mt", "it", "es", "de", "ja", "ar", "zh", "af", "nl"
...
def activation():
    ...
    torch.save(final_indice, f"activation_mask/llama-3")  
